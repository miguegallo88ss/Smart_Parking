...
//                         delay(pulseTime);  // pulse for 2mS **************************************************************************************************** 
                         ...
                         digitalWrite(buttonPin_8_Output, LOW); 
//                         Serial.println(data.tempDistance[0]);
//                         Serial.println(data.tempDistance[1]);
//                         Serial.println(data.tempDistance[2]);
//                         Serial.println(data.tempDistance[3]);
                         //delay(10);
...
void carLeaving(readings *data, readings *prev_Distance)
{
         if ((data->distance[0] > (distanceaDetectionTolerance*width_Of_Entrance_Exit))&&  // Car triggering only 2 sensoras, after all 4 have alredy been triggered
             (data->distance[1] > (distanceaDetectionTolerance*width_Of_Entrance_Exit))&&  // Car triggering only 2 sensoras, after all 4 have alredy been triggered
             (data->distance[2] <= width_Of_Entrance_Exit/2)&&
             (data->distance[3] <= width_Of_Entrance_Exit/2)&&
